...
require('packer').startup(function()
  ...
  use {'phaazon/hop.nvim', branch='v1'} -- Highlight motion
...
-- Programming
  ...
  use 'github/copilot.vim' -- AI companion
...
-- Languages
  ...
  use 'bfrg/vim-cpp-modern' -- C++ language support
  use 'kalvinpearce/ShaderHighlight' -- Shader language support
  use 'drichardson/vim-unreal' -- Unreal Engine support
end)
...
-- Hop configuration
require('hop').setup()
vim.api.nvim_set_keymap('n', '<leader>s', "<cmd>lua require'hop'.hint_patterns()<CR>", { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>k', "<cmd>lua require'hop'.hint_lines()<CR>", { noremap = true, silent = true })
...
wk.register({
  ...
  ["<leader>d"] = { name = "+debug" },
  ["<leader>l"] = { name = "+LSP" },
  ["<leader><space>"] = { name = "buffers" },
  ["<leader>?"] = { name = "oldfiles" },
})
...
vim.api.nvim_set_keymap("n", "<leader>dk", "<cmd>lua require'dap'.step_over()<CR>", { noremap = true, silent = true })
